...
folder_name = "FLEET_OOS_ARCHIVE"  # SET THE S3 BUCKET CONTAINING ALL THE FLEET_OOS HISTORICAL DATA: 'cvi_dev_admin/fleet-manual-archive/FLEET_OOS_DATA_ARCHIVE'
...
# 9. Write to Hive Table
#############################################################################
TARGET_TABLE_NAME = "dl_edge_base_dcfpa_171749_base_dcfpa_avista.fleet_oos_stg"
TARGET_TABLE_PATH = f"/sync/{ENV.lower()}_42124_edw_hi_b/DL/EDGE_BASE/DCFPA-171749/DCFPA-AVISTA/FLEET_OOS_STG/Data"
