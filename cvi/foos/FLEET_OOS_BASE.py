...
#############################################################################
TABLE_NAME = "dl_edge_base_dcfpa_171749_base_dcfpa_avista.fleet_oos_stg"
TABLE_PATH = f"/sync/{ENV.lower()}_42124_edw_hi_b/DL/EDGE_BASE/DCFPA-171749/DCFPA-AVISTA/FLEET_OOS_STG/Data"
